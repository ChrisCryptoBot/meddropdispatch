...
if (Test-Path .next) {
    ...
    Write-Host "SUCCESS: Deleted .next folder" -ForegroundColor Green
} else {
    Write-Host "INFO: .next folder doesn't exist" -ForegroundColor Yellow
}

# Remove Next.js cache
if (Test-Path node_modules/.cache) {
    Remove-Item -Recurse -Force node_modules/.cache
    Write-Host "SUCCESS: Deleted node_modules/.cache" -ForegroundColor Green
}

# Remove Prisma generated client (optional - will be regenerated)
if (Test-Path node_modules/.prisma) {
    Remove-Item -Recurse -Force node_modules/.prisma
    Write-Host "SUCCESS: Deleted node_modules/.prisma" -ForegroundColor Green
}
