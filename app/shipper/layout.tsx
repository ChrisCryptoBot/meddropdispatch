...
export default function ShipperLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <aside className="hidden md:block fixed left-0 top-[85px] w-64 bg-slate-900/95 backdrop-blur-xl border-r border-slate-700/50 z-[55]" style={{ height: 'calc(100vh - 85px)' }}>
      ...
      <main className="md:ml-64 min-h-screen pb-16 md:pb-0 pt-[85px] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
