...
export default function ShipperError({
  ...
  useEffect(() => {
    console.error('Shipper portal error:', error)
  }, [error])
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-medical-bg p-4">
      <div className="glass-primary max-w-md w-full rounded-2xl p-8 text-center border-2 border-blue-200/30 shadow-glass">
        ...
        <p className="text-gray-600 mb-6">
          We encountered an unexpected error in the shipper portal. Please try again or return to your dashboard.
        </p>
        ...
        <div className="flex gap-3">
          <button
            onClick={reset}
            className="flex-1 px-4 py-2 rounded-lg bg-gradient-primary text-white font-semibold hover:shadow-lg transition-all"
          >
            Try Again
          </button>
          <Link
